<div class="left-sidenav">
				<ul class="metismenu left-sidenav-menu" id="side-nav">
					...
					<li><a href="javascript: void(0);">
						<i class="fa fa-home"></i><span>Home</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
					...
					<li>
						<a href="javascript: void(0);">
							...
							<span>UI Elements</span><span class="menu-arrow">
						...
						<li>
							<a href="ui-tooltips-popovers.html">Tooltips & Popover</a>
						</li>
						<li>
				...
				<li>
					<a href="javascript: void(0);">
						<i class="mdi mdi-buffer"></i><span>Advanced UI</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span>
					</a>
					<ul class="nav-second-level" aria-expanded="false">
						<li>
						...
						<li>
							<a href="advanced-scrollbars.html">Scrollbars</a>
						</li>
					</ul>
				</li>
				<li>
				...
				<li>
					<a href="javascript: void(0);">
						<i class="mdi mdi-format-list-bulleted-type"></i><span>Tables</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span>
					</a>
					<ul class="nav-second-level" aria-expanded="false">
						<li>
				...
				<li>
					<a href="javascript: void(0);"><i class="mdi mdi-map"></i><span>Maps</span><span class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span>
					</a>
					<ul class="nav-second-level" aria-expanded="false">
						<li>
